...
1. Создать макет графического интерфейса системы
   * Определить структуру системы и список необходимых страниц (Главная страница, страница регистрации/авторизации, страница рекомендации и т.д.)
   * Определеить единый визуальный стиль системы
   * Реализовать макет согласно структуре и и визуальному стилю 
2. Спроектировать модель базы данных
   * Выделить необходимые для хранения сущности и связи между ними
   * Провести нормализацию данных
3. Определить параметры нейронной сети
   * Определить входные и выходные данных
   * Определить архитектуру (количество слоев, функция активации и т.д)
4. Реализовать базу данных
5. Сформировать обучающую и тестовую выборки для обучения нейросети
6. Реализовать нейронную сеть
   * Реализовать выбранную архитектуру
   * Обучить нейронную сеть
   * Протестировать на тестовой выборке
7. Реализовать графический интерфейс  
